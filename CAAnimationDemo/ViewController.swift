...
//    addLayerThree()
  ...
  private func addLayerOne() {
    ...
    // Create a CALayer, size 150x150, position 10,20, bgColor is blue
  ...
  private func addImageLayer() {
    ...
    imageLayer.frame = CGRect(x: view.frame.maxX, y: view.frame.maxY, width: 100, height: 100)
  }
  ...
  @IBAction func buttonTapped(_ sender: UIButton) {
    // Broken animation
     ...
     sender.layer.add(bgColorAnimation, forKey: nil)
